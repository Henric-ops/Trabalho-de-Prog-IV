...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card-custom" data-aos="fade-up">
            ...
            <form method="POST" action="{{ route('tccs.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-6" data-aos="fade-right" data-aos-delay="50">
                        ...
                        <input type="text" name="titulo" class="form-control" placeholder="Digite o título do TCC" required>
                    </div>
                    ...
                    <div class="col-md-6" data-aos="fade-left" data-aos-delay="50">
                        ...
                        <input type="text" name="aluno" class="form-control" placeholder="Nome do aluno" required>
                    </div>
                    ...
                    <div class="col-12" data-aos="fade-up" data-aos-delay="150">
                        ...
                        <textarea name="resumo" class="form-control" rows="4" placeholder="Digite um breve resumo do TCC" required></textarea>
                    </div>
                    ...
                    <div class="col-md-8" data-aos="fade-right" data-aos-delay="150">
                        ...
                        <input type="text" name="palavras_chave" class="form-control" placeholder="Ex: educação, tecnologia, inovação" required>
                    </div>
